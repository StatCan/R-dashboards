...
ui <- fluidPage(
  ...
  title=i18n$t("Movements of journeypersons"),
  
  fluidRow(
    column(10, h3(i18n$t("Movements of journeypersons"))),
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      checkboxInput(inputId = "showall",
                    label = i18n$t("Show the absence of mobility"),
                    value = FALSE),
    ...
    mainPanel(
      fillRow(
        plotOutput(outputId = "outPlot", width = "100%", height = "100%"), #%>% withSpinner(),
        width = "100%"
      )
    )
